...
INITIAL_X = 1000
INITIAL_Y_TOP = 100
FINAL_Y_TOP = INITIAL_Y_TOP + (INTER_COMPARTMENT_DISTANCE * COMPARTMENT_NUMBER * PIXEL_SCALE)
INITIAL_Y_BOTTOM = INITIAL_Y_TOP + (INTER_COMPARTMENT_DISTANCE * COMPARTMENT_NUMBER * PIXEL_SCALE) + (4 * PIXEL_SCALE)
FINAL_Y_BOTTOM = INITIAL_Y_BOTTOM + (INTER_COMPARTMENT_DISTANCE * COMPARTMENT_NUMBER * PIXEL_SCALE)
