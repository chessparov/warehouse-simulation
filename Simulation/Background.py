...
for i in range(v.SHELF_NUMBER):
    ...
    x_shelf = v.INITIAL_X - (i * INTER_SHELF)

    warehouse_shelves_top.append([(x_shelf, v.INITIAL_Y_TOP),
                                  (x_shelf, v.FINAL_Y_TOP)])

    warehouse_shelves_bottom.append([(x_shelf, v.INITIAL_Y_BOTTOM),
                                     (x_shelf, v.FINAL_Y_BOTTOM)])
